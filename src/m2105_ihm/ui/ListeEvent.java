 ...
 * @author IUT2
 */
public class ListeEvent extends javax.swing.JPanel  {
    /*
     * Principaux élements de l'arbre
     */
    private JTree                  listeEvent;
     ...
     * Constructeur
     */
    public ListeEvent(CarnetUI carnet) {
        this.carnet = carnet;
    ...
    private void initUIComponents() {  
         ...
         */
        listeEvent = new JTree(listeRacine);   
        listeEvent.setCellRenderer(new MyTreeCellRenderer());
        
        listeEvent.addTreeSelectionListener(new TreeSelectionListener() {
            /**
            ...
            public void valueChanged(TreeSelectionEvent e) {
                Object node, data;
                TreePath newSelected = listeEvent.getSelectionPath();
     ...
     */
    public void showAll() {        
        for(int i = listeEvent.getRowCount(); i >= 0; i--) {
          listeEvent.expandRow(i);
        }
    }
    ...
    public void updateEntry(Object c) {
        ...
        while(e.hasMoreElements()) {
            ...
            if (c == data.id ) {
                ...
                model = (DefaultTreeModel)listeEvent.getModel();
    ...
    private boolean ajouter(DefaultMutableTreeNode root, String title, Object itemData) {
        ...
        if ((title != null) && (itemData != null)) {
            ...
            /* redraw content */
            DefaultTreeModel model = (DefaultTreeModel)listeEvent.getModel();
            model.reload(listeRacine);
            showAll();            
